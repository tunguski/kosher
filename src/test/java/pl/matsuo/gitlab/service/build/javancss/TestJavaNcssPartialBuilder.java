...
@ContextConfiguration(classes = { TestConfig.class, MapDbDatabase.class, BuildServiceImpl.class,
                                  GitRepositoryServiceImpl.class, JavaNcssPartialBuilder.class })
public class TestJavaNcssPartialBuilder {
  ...
  public void testInternalExecute() throws Exception {
    ...
    assertTrue(new File(repository, "target/javancss-result.xml").exists());
