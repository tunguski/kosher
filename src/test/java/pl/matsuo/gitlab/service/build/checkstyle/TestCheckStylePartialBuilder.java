...
@ContextConfiguration(classes = { TestConfig.class, MapDbDatabase.class, BuildServiceImpl.class,
    GitRepositoryServiceImpl.class, CheckStylePartialBuilder.class })
public class TestCheckStylePartialBuilder {
  ...
  public void testInternalExecute() throws Exception {
    ...
    assertTrue(new File(repository, "target/checkstyle-result.xml").exists());
