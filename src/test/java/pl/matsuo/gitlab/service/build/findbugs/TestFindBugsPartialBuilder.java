...
@ContextConfiguration(classes = { TestConfig.class, MapDbDatabase.class, BuildServiceImpl.class,
                                  GitRepositoryServiceImpl.class, FindBugsPartialBuilder.class })
public class TestFindBugsPartialBuilder {
  ...
  public void testInternalExecute() throws Exception {
    ...
    assertTrue(new File(repository, "target/findbugsXml.xml").exists());
