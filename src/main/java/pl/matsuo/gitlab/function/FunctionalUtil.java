...
public class FunctionalUtil {
  ...
  /**
   * Objects provide access to some element. It may be getter/setter pair or get/set field directly. Abstracted over
   * implementation.
  ...
  public static <E> AccessProvider<E> access(Object object, Field field) {
    return access(() -> ignoreEx(() -> { return (E) field.get(object); }),
        value -> ignoreEx(() -> { field.set(object, value); return null; }));
  }
   ...
   */
  public static final Consumer<Exception> ignoringExConsumer = e -> logger.warn("Ignoring exception", e);
  /**
   * Consumer that throws RuntimeException with passed exception as root cause.
   */
  public static final Consumer<Exception> runtimeExConsumer = e -> { throw new RuntimeException(e); };
  ...
  public static <E> E ignoreEx(ThrowingExceptionsSupplier<E> throwsExceptions) {
    return processEx(throwsExceptions, e -> {
  ...
  public static <E> E runtimeEx(ThrowingExceptionsSupplier<E> throwsExceptions) {
    return processEx(throwsExceptions, e -> { throw new RuntimeException(e); });
  }
  ...
  /**
   * Creates stream consisting of elements returned by invocations of supply. Length of stream is established by
   * condition.
   */
